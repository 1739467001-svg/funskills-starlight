...
window.WORKS = [
  ...
  { slug:"time-travel", title:"古今穿越旅行对照薄", en:"Z 世代特种兵旅行 · 历史彩蛋触发器", author:"法小蕾", wechat:"_fxl2026", track:"生活成长",
    tagline:"让旅行不再是打卡流水线", tags:["旅行","历史","生活"],
    blurb:"在 Z 世代的特种兵旅行时，基于情景自动触发历史彩蛋，让旅行不再是打卡流水线的工具。" }
];
